      ...
      guides: [
        {
          ...
          steps: [
            ...
            { action: '업데이트 다운로드 후 로그인', detail: '업데이트 다운로드가 완료되면 자동으로 프로그램이 다시 시작됩니다. 정상적으로 로그인해주세요.', image: null },
          ],
        ...
        },
        {
          ...
          steps: [
            ...
            { action: '동기화 버튼 누르기', detail: '설정 화면에서 "동기화" 버튼을 눌러주세요. 최신 데이터를 서버에서 받아옵니다.', image: '/images/업데이트-동기화/동기화/step1.jpg' },
