      ...
      guides: [
        {
          ...
          shortcut: '0 > 1 > 0 > 1',
          steps: [
            { action: '0 버튼 누르기', detail: '단말기 기본 화면에서 숫자 0번을 눌러주세요', image: '/images/단말기-결제오류/긴영수증/step1.jpg' },
        ...
        },
        {
          ...
          steps: [
            ...
            { action: '1 버튼 (통합정산)', detail: '정산종류에서 통합정산[1]을 선택해주세요', image: '/images/단말기-결제오류/호스트영수증/step3.jpg' },
