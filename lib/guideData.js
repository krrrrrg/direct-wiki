      ...
      guides: [
        {
          ...
          steps: [
            ...
            { action: '총액 확인 후 시작하기', detail: '입력한 권종별 수량이 맞는지 총액을 확인한 뒤 "시작하기" 버튼을 눌러주세요.', image: null },
          ],
        ...
        },
        {
          ...
          steps: [
            ...
            { action: '날짜 및 지출구분 선택', detail: '비용이 발생한 날짜와 지출구분을 선택해주세요.', image: null },
            { action: '금액 입력 및 영수증 첨부', detail: '금액과 사유를 입력하고 영수증을 첨부한 뒤 "비용 등록" 버튼을 눌러주세요.', image: null },
          ],
      ...
      guides: [
        ...
        },
        {
          ...
          steps: [
            ...
            { action: '현금영수증 발행 시', detail: '현금영수증번호를 입력한 뒤 결제를 진행해주세요.', image: null },
          ],
        ...
        },
        {
          ...
          steps: [
            ...
            { action: '1차 결제 수단 선택', detail: '1차로 결제할 수단(카드/현금/이체)을 선택합니다.', image: null },
            { action: '남은 금액 결제', detail: '남은 결제 금액 중 다음으로 결제할 금액을 입력하고 결제 수단을 선택합니다. 남은 결제 금액이 0원이 될 때까지 반복합니다.', image: null },
          ],
        ...
        },
        {
          id: 'playmd-refund',
          title: 'PLAY MD 환불',
          symptom: 'PLAY MD를 통해 결제된 제품을 환불 처리하는 방법',
          keywords: ['PLAY MD', '플레이엠디', '환불', 'PLAYMD'],
          shortcut: null,
          steps: [
            { action: '결제 등록 확인 진입', detail: '하단 메뉴에서 결제 등록 확인 화면으로 이동합니다.', image: '/images/POS-결제/PLAYMD환불/step1.png' },
            { action: 'PLAY MD 환불 버튼 클릭', detail: '해당 건을 선택 후 PLAY MD 환불 버튼을 눌러주세요.', image: null },
          ],
          note: 'PLAY MD를 통해 결제된 제품은 먼저 PLAY MD에서 환불 처리하고, 이후 동일 건을 돌핀POS에도 환불 등록해야 합니다.'
        },
        {
        ...
        },
        {
          ...
          steps: [
            ...
            { action: '해당 주문 선택', detail: '환불하려는 주문을 선택해주세요.', image: null },
            { action: '환불할 내역 더블클릭', detail: '환불하려는 항목을 더블클릭합니다.', image: null },
            { action: '환불 버튼 클릭', detail: '우측의 "환불" 버튼을 눌러 환불을 완료합니다.', image: null },
          ],
          note: null
        }
      ]
      ...
      guides: [
        {
          ...
          steps: [
            ...
            { action: '고객 번호 입력', detail: '고객님이 CAT단말기로 휴대폰 번호 뒤 4자리를 입력합니다. (키보드로도 입력 가능)', image: null },
            { action: '분실한 제품 선택', detail: '고객님께 확인 후 분실한 제품을 선택해주세요.', image: null },
        ...
        },
        {
          ...
          steps: [
            ...
            { action: '고객 번호 입력', detail: '고객님이 CAT단말기로 휴대폰 번호 뒤 4자리를 입력합니다.', image: null },
            { action: '고객 확인 후 제품 선택', detail: '고객 정보를 확인하고 해당 제품을 선택합니다.', image: null },
        ...
        },
        {
          ...
          steps: [
            ...
            { action: '고객 번호 입력', detail: '고객님이 CAT단말기로 휴대폰 번호 뒤 4자리를 입력합니다.', image: null },
            { action: '이용 중 제품 확인 후 선택', detail: '고객님께 이용 중인 제품을 확인하고 선택합니다.', image: null },
      ...
      guides: [
        {
          ...
          steps: [
            ...
            { action: '제품 바코드 스캔 및 고객조회', detail: '제품 바코드를 스캔하고, 고객님이 CAT단말기로 번호를 입력합니다.', image: null },
            { action: '고객 정보 확인 후 등록', detail: '기존 고객이면 바로 등록, 신규 고객이면 고객 정보를 입력 후 등록합니다.', image: '/images/등록-서비스/레드라벨/step2.png' },
          ],
        ...
        },
        {
          ...
          steps: [
            ...
            { action: '배송 리스트 선택 및 비밀번호 입력', detail: '해당 제품의 배송 리스트를 선택하고, 등록 비밀번호를 입력합니다. 신규 고객이면 고객 정보를 입력해주세요.', image: '/images/등록-서비스/정품등록/step2.png' },
            { action: '등록 버튼 클릭', detail: '"등록" 버튼을 눌러 정품등록을 완료합니다.', image: null },
          ],
        ...
        },
        {
          ...
          shortcut: null,
          steps: [
            { action: 'A/S 메뉴 선택', detail: '하단 메뉴에서 "A/S"를 선택해주세요.', image: '/images/등록-서비스/AS/step1.png' },
            { action: '고객 번호 입력', detail: '고객님이 CAT단말기로 휴대폰 번호 뒤 4자리를 입력합니다.', image: null },
            { action: '제품 확인 및 불량 증상 선택', detail: '고객님의 제품을 확인하고, 해당하는 불량 증상을 선택합니다.', image: null },
            { action: 'A/S 등록 버튼 클릭', detail: '"A/S 등록" 버튼을 눌러 접수를 완료합니다.', image: null },
          ],
          note: null
        },
        {
          ...
          shortcut: null,
          steps: [
            { action: '통합조회에서 원래 주문 검색', detail: '통합조회 화면에서 교환할 결제 내역을 검색합니다.', image: '/images/등록-서비스/교환/step1.png' },
            { action: '기존 제품 체크박스 선택', detail: '기존 제품을 담은 후 체크박스를 선택해주세요.', image: null },
            { action: '교환할 상품 담기', detail: '교환하고자 하는 새 상품을 담아주세요.', image: null },
            { action: '교환하기 버튼 클릭', detail: '"교환하기" 버튼을 눌러 교환을 완료합니다.', image: null },
          ],
        ...
        },
        {
          ...
          steps: [
            ...
            { action: '판매자 페이지에서 이벤트 등록', detail: '이벤트 등록은 판매자 페이지에서 진행됩니다. 안내에 따라 진행해주세요.', image: null },
          ],
      ...
      guides: [
        ...
        },
        {
          ...
          steps: [
            ...
            { action: '입고확인 버튼 클릭', detail: '내역을 확인한 뒤 "입고확인" 버튼을 눌러주세요. 실제고 수량 입력도 가능합니다.', image: null },
          ],
          note: null
        },
        {
          ...
          steps: [
            ...
            { action: '조회 결과 확인', detail: '설정한 조건에 맞는 결과가 표시됩니다. 상세 내역을 클릭하면 세부 정보를 확인할 수 있습니다.', image: null },
          ],
          note: null
        },
        {
          ...
          steps: [
            ...
            { action: '보류목록 조회', detail: '"보류목록 조회" 메뉴에서 보류된 건들을 확인할 수 있습니다.', image: null },
            { action: '보류 건 결제 진행', detail: '보류된 건을 더블클릭하면 상세 화면으로 이동하여 결제를 진행할 수 있습니다.', image: null },
          ],
          note: null
        }
      ]
